;(function( $ ){
	...
	URL = 'http://test1.atplus.com.ua/';		
		
	var defaults = {  
	   borderColor: "",  
	   captchaDir: URL+"captcha",  
	   url: URL+"captcha/captcha.php",  
	   formId: "myForm",  
	   text: "Проверка на человечность,<br />перетащите <span></span> в круг.",
	   items: Array("pencil", "scissors", "clock", "heart", "note"),
	   itemsRu: Array("карандаш", "ножницы", "часы", "сердце", "ноту") 
	  };	
	...
	$("p#ajax-fc-task span").html(options.itemsRu[pic]);
